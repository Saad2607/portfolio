...
const ResumeSection = () => {
  return (
    <section id="resume" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-20 w-full overflow-hidden">
      <SectionHeading
      ...
      <motion.div
        ...
        className="rounded-3xl bg-gradient-to-br from-blue-50/90 via-white to-blue-50/40 border border-slate-200 dark:from-slate-900/80 dark:via-slate-900/50 dark:to-blue-950/30 dark:border-slate-800 p-5 sm:p-10 md:p-12 text-left relative overflow-hidden shadow-md dark:shadow-2xl w-full"
      >
        {/* Background glow */}
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6 w-full">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 break-words">
                {personalInfo.name}
              </h3>
            ...
            <div className="space-y-2 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
              <div className="flex items-start gap-2">
                <FaCheck className="text-blue-600 dark:text-blue-400 text-xs shrink-0 mt-0.5" />
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center p-6 sm:p-8 rounded-2xl bg-white/90 border border-slate-200 dark:bg-slate-950/80 dark:border-slate-800 text-center shadow-sm dark:shadow-none w-full">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-blue-50 dark:bg-blue-600/10 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-500/20 flex items-center justify-center text-2xl sm:text-3xl mb-4">
              <FaFilePdf />
            </div>
            ...
            <div className="w-full space-y-3">
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-5 rounded-xl font-semibold text-xs sm:text-sm bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-500/25 transition transform hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-5 rounded-xl font-medium text-xs sm:text-sm bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-200 dark:border-slate-700 transition transform hover:-translate-y-0.5 shadow-sm dark:shadow-none"
              >
